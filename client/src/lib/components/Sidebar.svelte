...
<section class="w-screen h-screen">
  {#if sidebarOpen}
    <aside class="fixed h-full w-60 bg-gray-50" transition:fly="{{ x: -100, duration: 200 }}">
      <div class="flex-grow overflow-x-hidden overflow-y-auto">
        <ul class="flex flex-col py-4 space-y-1">
          ...
          <li>
            <a href="/" class="relative flex flex-row items-center pr-6 text-gray-600 border-l-4 border-transparent h-11 focus:outline-none hover:bg-gray-50 hover:text-gray-800 hover:border-indigo-500">
          ...
          <li>
            <button on:click={logout} class="relative flex flex-row items-center pr-6 text-gray-600 border-l-4 border-transparent h-11 focus:outline-none hover:bg-gray-50 hover:text-gray-800 hover:border-indigo-500">
              <span class="inline-flex items-center justify-center ml-4">
